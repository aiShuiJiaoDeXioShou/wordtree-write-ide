...
public class NewBoxController {
    ...
    public NewBoxController(NewBoxView newBoxView) {
        ...
        view.splitPane.getItems().addAll(view.listView, novelInit());
    ...
    public void toggle(Node node) {
        view.splitPane.getItems().remove(1);
        view.splitPane.getItems().add(1,node);
        view.splitPane.setDividerPosition(0, 0.3);
    }

    public BorderPane novelInit() {
        view.novel = new BorderPane();
        // 新建一个小说
        ...
        choose.setOnMouseClicked(e->{
            ...
            File file = fileChooser.showDialog(view);
        ...
        chooseImg.setOnMouseClicked(e->{
            ...
            fileImage.set(fileChooser.showOpenDialog(view));
        ...
        view.novel.setTop(boxRoot);
        view.novel.setBottom(buttons);
        view.novel.setPadding(new Insets(20));
        return view.novel;
    }
}
