...
public class OneWindow extends Stage {
    ...
    public OneWindow(String myTitle) {
        this.myTitle = myTitle;
        this.label.setText(this.myTitle);
        this.init();
    }

    public OneWindow(Pane root, double minWidth, double minHeight) {
    ...
    public OneWindow(double minWidth, double minHeight) {
        this.MIN_WIDTH = minWidth;
        this.MIN_HEIGHT = minHeight;
        this.init();
    }
